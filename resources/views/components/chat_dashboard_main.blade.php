                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto" style="width: 73vw;">
                                    <div class="pt-3 pe-3 scrollable-content" style="position: relative; height: 73vh">
                                    ...
                                    <div
                                        ...
                                        <a class="ms-3 send_chat_btn text-light p-2 rounded-3" data-bs-toggle="modal"
                                            href="#addToBookmark"><i class="bi bi-bookmark-plus-fill"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
