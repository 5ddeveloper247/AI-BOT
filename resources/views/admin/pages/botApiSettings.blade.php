                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto">
                        <a href="javascript:;" class="btn btn-light radius-30 mt-2 mt-lg-0" data-bs-toggle="modal"
                            ...
                            <i class="bx bxs-plus-square"></i>Add Settings
                        </a>
                    </div>
                </div>
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: rgb(9,70,115)">
            ...
            <form action="{{ route('admin.botConfiguration.submit') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="cientId" class="form-control" id="clientId" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3">
