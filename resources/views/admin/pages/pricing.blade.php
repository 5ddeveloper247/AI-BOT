                    ...
                    <div class="card-body p-4">
                        <form class="row g-3 needs-validation" novalidate>
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="mainTitle" placeholder="Main Title" rows="2" maxlength="100" required onkeypress="return event.charCode < 48 || event.charCode > 57" required></textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="button" placeholder="Button text" maxlength="10" required>
                                <div class="invalid-feedback">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto">
                        <a href="javascript:;" class="btn btn-light radius-30 mt-2 mt-lg-0" data-bs-toggle="modal" data-bs-target="#addModal">
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger mx-2" data-bs-toggle="modal" data-bs-target="#editModal" data-id="{{ $plan->id }}" data-name="{{ $plan->plan_name }}" data-name-description="{{ $plan->plan_name_description }}" data-tittle="{{ $plan->plan_tittle }}" data-tittle-description="{{ $plan->plan_tittle_description }}" data-price="{{ $plan->plan_price }}" data-input-word-limits="{{ $plan->input_word_limit }}" data-output-word-limits="{{ $plan->output_word_limit }}" onclick="populateEditModal('{{ $plan->id }}', '{{ $plan->plan_name }}', '{{ $plan->plan_name_description }}', '{{ $plan->plan_tittle }}', '{{ $plan->plan_tittle_description }}', '{{ $plan->plan_price }}', '{{ $plan->input_word_limit }}', '{{ $plan->output_word_limit }}')">
                                        <i class="bx bxs-edit"></i>
                                    </button>


                                    <button class="btn btn-danger" onclick="confirmDeletePlan({{ $plan->id }})">
                                        <i class="bx bxs-trash"></i>
                                    </button>

                                    <button class="btn btn-success add-feature-btn" onclick="Showmodal({{ $plan->id }})">
                                        <i class="bx bx-plus"></i>
                                    </button>

                                    <button class="btn btn-success add-feature-btn" onclick="showPlanDetails({{ $plan->id }})">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: rgb(9,70,115)">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="addPlanTittle" class="form-label">Plan Tittle</label>
                    <input type="text" class="form-control" id="addPlanTittle">
                </div>
                <div class="mb-3">
                    <label for="addPlanTittleDescription" class="form-label">Plan Tittle Description</label>
                    <textarea type="text" class="form-control" rows="2" id="addPlanTittleDescription"></textarea>
                </div>
                <div class="mb-3">
                    <label for="addPlanPrice" class="form-label">Plan Price</label>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: rgb(9,70,115)">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="editPlanTittle" class="form-label">Plan Tittle</label>
                    <input type="text" class="form-control" id="editPlanTittle">
                </div>
                <div class="mb-3">
                    <label for="editPlanTittleDescription" class="form-label">Plan Tittle Description</label>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: rgb(9,70,115)">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" onclick="confirmAndDeletePlan()" id="confirmDeleteButton">Delete</button>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3 needs-validation" novalidate>
                            <div class="col-md-12">
                                <label for="mainTitle" class="form-label fs-5"> Title</label>
                                <!-- Increased label size -->
                                <textarea class="form-control" id="mainTitle" placeholder="Main Title" rows="2" maxlength="25" required onkeypress="return event.charCode < 48 || event.charCode > 57" required></textarea>
                                <div class="invalid-feedback">
                                    Please enter a main title (maximum 100 characters).
                                </div>
                            </div>
