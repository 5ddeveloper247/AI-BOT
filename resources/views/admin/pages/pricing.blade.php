                    ...
                    <div class="card-body p-4">
                        <form class="row g-3 needs-validation" novalidate>
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="mainTitle" placeholder="Main Title" rows="2"
        ...
        <div class="modal-content" style="background-color: rgb(9,70,115)">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3  ">
                    ...
                    <select class="form-select has-arrow" id="planType" name="planType">
                        <option value="" selected disabled>Select Type</option>
                        <option value="Bot 1">Bot 1</option>
                        <option value="Bot 2">Bot 2</option>
                        <option value="Bot 1 + Bot 2">Bot 1 + Bot 2</option>
