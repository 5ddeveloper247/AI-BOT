...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Add Payment Gateway Settings</h6>
        <hr />
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto">
                        <a href="javascript:;" class="btn btn-light radius-30 mt-2 mt-lg-0" data-bs-toggle="modal"
                            ...
                            <i class="bx bxs-plus-square"></i>Add Api Settings
                        </a>
                    </div>
                </div>
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody id="sortable">
                            ...
                            <tr id="record_{{ $record->id }}">
                                <td>{{ $loop->index + 1 }}</td>
                                <td>{{ $record->name }}</td>
                                <td>{{ $record->transaction_key }}</td>
                                <td>
                                    <div
                                        class="form-check form-switch d-flex justify-content-center align-items-center">
                                        <input style="font-size: 20px;" type="checkbox" {{ $record->status ? 'checked' :
                                        ''
                                ...
                                <td class="Checkbox">
                                    <div class="form-check d-flex justify-content-center align-items-center">
                                        ...
                                        <input style="font-size: 20px; margin:2px;" type="checkbox"
...
{{-- handle error if any occurs while adding record --}}
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: rgb(9,70,115)">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Add Config</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>


            <form action="{{ route('admin.paymentapisettings.submit') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            <h6 class="mb-0">Name(Client Id)</h6>
                        </div>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            <h6 class="mb-0">Transaction Key</h6>
                        </div>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="addTransactionKey" id="addTransactionKey" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9">
                            <input style="font-size: 20px;" type="checkbox" name="status" class="form-check-input"
                                id="status" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input type="radio" id="live" name="type" class="form-check-input" value="live" checked>
                                <label class="form-check-label" for="live">Live</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="sandbox" name="type" class="form-check-input" value="sandbox">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="disable-button">Save</button>
                </div>
            </form>
